...
function Rightbar() {
  ...
  return (
    <div className={`col-span-2 px-8 hidden lg:flex flex-col rounded-md`}>
      ...
      <div className="bg-[#eaebed] dark:bg-[#1d2a49] my-4 rounded-md flex flex-col justify-center gap-2">
        <div className="">
          <img
        ...
        <div className="px-4 py-2 font-sm mb-4 font-bold bg-[#b9babb] dark:bg-primary_light">
          $ {userData.balance}
        </div>
      </div>
    </div>
